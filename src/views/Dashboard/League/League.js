...
import LeagueTableRow from "components/League/LeagueTableRow";
import CreateLeagueDialog from "components/League/CreateLeagueDialog";
...
function League() {
  ...
  const [{ data, loading, error }, refetch] = useAxios({
    url: ROOT_API + API_ROUTES.LEAGUES,
    params: filter,
  });
  const onImportCountryCode = async () => {
    if (
      window.confirm(
        "Are you sure to reset and create again the top leagues?"
      )
    ) {
